...
export const competition = {
  ...
  registration: {
     ...
     *
     *  2026-07-30 실측값 (32문항, 화면 너비별):
     *    휴대폰 320px → 7,110px  ← 가장 김 (좁을수록 글자가 접혀서 길어짐)
     *    휴대폰 390px → 6,694px  (아이폰 14/15)
     *    태블릿 640px → 6,304px
     *    데스크톱     → 6,220px  ← 가장 짧음
     *
     *  현재 값 7300 은 '가장 긴 경우(7,110)'에 맞춘 값입니다.
     *  → 어떤 휴대폰에서도 폼 안쪽 스크롤바가 생기지 않습니다.
     *  → 넓은 화면에서는 아래에 약 1,000px 여백이 남지만,
     *     그 여백은 '제출' 버튼보다 아래에 있어서 문제되지 않습니다.
     *
     *  【 질문을 추가·삭제했을 때 】
     *   질문 1개당 대략 150~250px 늘거나 줄어듭니다.
