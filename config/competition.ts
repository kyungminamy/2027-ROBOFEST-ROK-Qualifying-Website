...
export const competition = {
  ...
  registration: {
     ...
     *
     *  2026-07-30 실측값 (34문항, 화면 너비별):
     *    휴대폰 320px → 7,906px  ← 가장 김 (좁을수록 글자가 접혀서 길어짐)
     *    휴대폰 375px → 7,470px
     *    휴대폰 390px → 7,358px  (아이폰 14/15)
     *    태블릿 640px → 6,818px
     *    데스크톱     → 6,734px  ← 가장 짧음
     *
     *  현재 값 8100 은 '가장 긴 경우(7,906)'에 맞춘 값입니다.
     *  → 어떤 휴대폰에서도 폼 안쪽 스크롤바가 생기지 않습니다.
     *  → 넓은 화면에서는 아래에 약 1,400px 여백이 남지만,
