...
고치고 올리는 방법을 익혔고, 그중 한 명이 **주 담당자**입니다.
누구인지는 [`docs/RUNBOOK.md`](docs/RUNBOOK.md) 12번 표에 있습니다.

**새로 맡으신 분은 [`docs/RUNBOOK.md`](docs/RUNBOOK.md) 부터 읽으세요.**
평소에는 아무것도 하지 않아도 됩니다. **날짜가 정해진 일은 두 번뿐입니다** —
9월 1일과 10월 17일에 접수가 제대로 열리고 닫혔는지 확인하는 것(3-4번).

남은 항목은 [`CLAUDE.md`](CLAUDE.md) 맨 아래 체크리스트와
